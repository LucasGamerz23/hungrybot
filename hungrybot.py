...
async def help(ctx):
    ...
    embed.set_author(name="A Hunger Games simulator", icon_url=ctx.author.avatar_url)

    embed.add_field(name="h!new", value="Start a new Hunger Games simulation in the current channel.")
    embed.add_field(name="h!join", value="Adds a tribute with your name to a new simulation.")
    embed.add_field(name="h!add", value="Add a user to a new game.")
    embed.add_field(name="h!remove", value="Remove a user from a new game.")
    embed.add_field(name="h!fill", value="Pad out empty slots in a new game with default characters.")
    embed.add_field(name="h!status", value="Gets the status for the game in the channel.")
    embed.add_field(name="h!start", value="Starts the pending game in the channel.")
    embed.add_field(name="h!end", value="Cancels the current game in the channel.")
    embed.add_field(name="h!step", value="Steps forward the current game in the channel by one round.")
